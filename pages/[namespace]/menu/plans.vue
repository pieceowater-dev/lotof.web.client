...
async function subscribePlan(plan: Plan) {
  ...
  if (plan.amountCents > 0 && (plan.trialDays === 0 || trialAlreadyUsed)) {
    useContactUsModal().open({ app: 'pieceowater.menu', planName: plan.name });
    return;
  }
...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <BillingBundlesForApp application-code="pieceowater.menu" :namespace="nsSlug" :interval="selectedInterval" />
